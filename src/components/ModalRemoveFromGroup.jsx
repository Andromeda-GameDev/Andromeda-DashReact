...
function ModalRemoveFromGroup(props){
    ...
    return(
        ...
        <div className="flex items-center justify-center min-h-screen p-4">
            ...
            <div className="p-4">
                ...
                <button
                    type="button"
                    className="mr-2 px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-red-500 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                    onClick={handleSave}
                >
                    Delete
                </button>
...
export default ModalRemoveFromGroup;