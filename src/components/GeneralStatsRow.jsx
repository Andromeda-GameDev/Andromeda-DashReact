        ...
        for (let userId in progress) {
          for (let i = 0; i < usersArray.length; i++) {
            ...
            if (usersArray[i].mat === users[userId].email.split("@")[0]) {
              ...
              usersArray[i].secOneS =
                progress[userId].level_1.section_1.time.toFixed(1);
              usersArray[i].secOneY =
                progress[userId].level_1.section_1.attempts;

              usersArray[i].secTwoT = progress[userId].level_1.section_2.score;
              usersArray[i].secTwoS =
                progress[userId].level_1.section_2.time.toFixed(1);
              usersArray[i].secTwoY =
                progress[userId].level_1.section_2.attempts;

              usersArray[i].secThreeT =
                progress[userId].level_1.section_3.score;
              usersArray[i].secThreeS =
                progress[userId].level_1.section_3.time.toFixed(1);
              usersArray[i].secThreeY =
                progress[userId].level_1.section_3.attempts;

              usersArray[i].secFourT = progress[userId].level_1.section_4.score;
              usersArray[i].secFourS =
                progress[userId].level_1.section_4.time.toFixed(1);
              usersArray[i].secFourY =
                progress[userId].level_1.section_4.attempts;
            }
          }
        }
      } else {
        ...
        for (let userId in progress) {
          if (users[userId].group === groupName) {
            for (let i = 0; i < usersArray.length; i++) {
              ...
              if (usersArray[i].mat === users[userId].email.split("@")[0]) {
                usersArray[i].secOneT =
                  progress[userId].level_1.section_1.score;
                usersArray[i].secOneS =
                  progress[userId].level_1.section_1.time.toFixed(1);
                usersArray[i].secOneY =
                  progress[userId].level_1.section_1.attempts;

                usersArray[i].secTwoT =
                  progress[userId].level_1.section_2.score;
                usersArray[i].secTwoS =
                  progress[userId].level_1.section_2.time.toFixed(1);
                usersArray[i].secTwoY =
                  progress[userId].level_1.section_2.attempts;
                ...
                usersArray[i].secFourT =
                  progress[userId].level_1.section_4.score;
                usersArray[i].secFourS =
                  progress[userId].level_1.section_4.time.toFixed(1);
                usersArray[i].secFourY =
                  progress[userId].level_1.section_4.attempts;
        ...
        <tr key={index}>
          ...
          <td className="whitespace-nowrap bg-gray-200">
            <div className="flex items-center justify-center">
              <div className="min-w-min h-10 shrink-0 mr-2 sm:mr-3">
