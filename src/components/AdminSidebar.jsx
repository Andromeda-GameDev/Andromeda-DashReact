      ...
      <li>
        <NavLink
          ...
          className={`flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 ${
            isActive ? "text-gray-800 bg-green-100" : "text-gray-500 hover:text-gray-800"
          }`}
        >
          <span
        ...
        <div className="fixed">
            ...
            <div className="flex flex-col w-56 bg-white overflow-hidden">
                <div className="flex items-center justify-center h-20 shadow-md">
                    ...
                    <h1 className="text-2xl text-green-500">Andromeda</h1>
                </div>
                <ul className="flex flex-col py-4">
                  <SidebarLink to="/admin" label="Inicio" />
                  <SidebarLink to="/admin/users" label="Alumnos" />
                  <SidebarLink to="/admin/professors" label="Profesores" />
                  <SidebarLink to="/admin/settings" label="Ajustes" />
                  <li>
